...
const trackedComponentCatalogs = defineCompleteCatalogs({
  "zh-TW": {
    ...
    "notFound.message": "找不到這個頁面。", "notFound.home": "返回首頁", "notFound.documentTitle": "找不到頁面｜HandFuture",
  ...
  "zh-CN": {
    ...
    "notFound.message": "找不到这个页面。", "notFound.home": "返回首页", "notFound.documentTitle": "找不到页面｜HandFuture",
  ...
  en: {
    ...
    "notFound.message": "Page not found.", "notFound.home": "Return home", "notFound.documentTitle": "Page not found | HandFuture",
  ...
  ja: {
    ...
    "notFound.message": "ページが見つかりません。", "notFound.home": "ホームに戻る", "notFound.documentTitle": "ページが見つかりません｜HandFuture",
  ...
  ko: {
    ...
    "notFound.message": "페이지를 찾을 수 없습니다.", "notFound.home": "홈으로 돌아가기", "notFound.documentTitle": "페이지를 찾을 수 없습니다 | HandFuture",
  ...
  es: {
    ...
    "notFound.message": "No se encontró la página.", "notFound.home": "Volver al inicio", "notFound.documentTitle": "Página no encontrada | HandFuture",
  ...
  "pt-BR": {
    ...
    "notFound.message": "Página não encontrada.", "notFound.home": "Voltar ao início", "notFound.documentTitle": "Página não encontrada | HandFuture",
  ...
  fr: {
    ...
    "notFound.message": "Page introuvable.", "notFound.home": "Retour à l’accueil", "notFound.documentTitle": "Page introuvable | HandFuture",
